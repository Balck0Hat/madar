import { HEX_DARK as C, FONT } from "../../../shared/constants/theme";
...
export default function ShareCard({ profile, progress, level, refEl }) {
  ...
  return (
    <svg ref={refEl} viewBox="0 0 360 640" width="100%" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", borderRadius: 18 }}>
      ...
      <svg x="30" y="120" width="300" height="300" viewBox="-26 -26 412 412"><WheelBody progress={progress} level={level} compact sky={false} palette={C} /></svg>
