...
export default function LibraryScreen({ progress, onBack, onOpenUnit, onOpenFigure, onOpenBookChapter }) {
    ...
    <div className="madar-in madar-col" style={{ paddingBottom: S.x8 }}>
      ...
      <div style={{ padding: `0 ${S.x4}px` }}>
        {tab === "summaries"
          ...
          : <MyHighlights onBack={onBack} onOpenUnit={onOpenUnit} onOpenFigure={onOpenFigure} onOpenBookChapter={onOpenBookChapter} />}
      </div>
    </div>
  );
}
