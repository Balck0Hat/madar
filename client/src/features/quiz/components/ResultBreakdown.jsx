...
const TOTAL = { fontFamily: MONO, color: C.gold, display: "flex", alignItems: "center", gap: 4 };
...
function Total({ gain }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 10, fontWeight: 800, position: "relative" }}>
      <span>المجموع</span>
