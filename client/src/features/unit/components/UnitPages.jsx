  ...
  return (
    <div>
      ...
      <div style={{ background: P.card, border: `1px solid ${P.line}`, borderRadius: 16, padding: "12px 14px" }}>
        ...
        <div style={{ ...body, fontSize: ".97em" }}>{deep.why}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gap: 8 }}>
        {summary.map((s, i) => <div key={i} style={{ ...body, fontSize: ".97em", lineHeight: 1.8, display: "flex", gap: 10 }}><Check size={16} color={P.gold} style={{ flexShrink: 0, marginTop: 5 }} />{s}</div>)}
      </div>
