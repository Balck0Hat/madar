  ...
  return (
    <div role="presentation" onClick={onClose}
      ...
      <div ref={box} tabIndex={-1} role="dialog" aria-modal="true" aria-label="فهرس الدرس" className="madar-rise"
        ...
        <div style={{ width: 40, height: 4, borderRadius: R.pill, background: P.line, margin: "0 auto 12px" }} aria-hidden="true" />
        <div style={{ fontWeight: 900, fontSize: T.xl, marginBottom: 10 }}>فهرس الدرس</div>
            ...
            return (
              <button key={i} type="button" onClick={() => onPick(i)} aria-current={on ? "true" : undefined}
                style={{
                  ...
                  minHeight: 44, padding: "8px 10px", borderRadius: R.lg, fontFamily: "inherit", fontSize: T.md,
                ...
                {on && <span style={{ fontSize: T.xs, color: P.gold, fontWeight: 800 }}>هنا</span>}
              </button>
            );
          })}
        </div>
