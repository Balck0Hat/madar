...
export default function WeeklyXpChart({ weeks }) {
  ...
  return (
    <section style={{ background: C.surface, border: `1px solid ${C.line}`, borderRadius: R.x3, padding: S.x4 }}>
      <h2 style={{ margin: 0, fontSize: T.lg, fontWeight: 700 }}>نقاطك الأسبوعية</h2>
      <p style={{ margin: `${S.xs}px 0 ${S.md}px`, color: C.muted, fontSize: T.sm }}>آخر {num(data.length)} أسابيع — المجموع {num(total)} نقطة</p>
