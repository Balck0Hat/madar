  ...
  return (
    <div className="madar-in" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "56px 24px 32px" }}>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ color: C.muted, marginTop: 14, fontSize: 15, lineHeight: 1.8 }}>خريطة واحدة لكل المعرفة: 10 مجالات، 3 مدارات، 243 وحدة. بساعة يومياً تصل إلى شهادة إتمام المدار الأول.</div>
      </div>
