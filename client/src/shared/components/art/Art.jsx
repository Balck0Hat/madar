import { C, P, alpha, R } from "../../constants/theme";
...
export default function Art({ k, color = C.gold, height = 150, bg = P.panel }) {
  return (
    <div style={{ background: bg, borderRadius: R.x3, padding: "8px 12px", height, display: "grid", placeItems: "center", border: `1px solid ${alpha(color, 0.3)}`, position: "relative", overflow: "hidden" }}>
